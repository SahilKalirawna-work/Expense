...
function App() {
	...
	const [curatedItems, setCuratedItems] = useLocalStorage<CuratedItem[]>(
		"curated_items",
		DEFAULT_ITEMS
	);
	...
	const addCuratedItem = useCallback(
	...
	const deleteCuratedItem = useCallback(
		(id: string) => {
	...
	const updateCuratedItem = useCallback(
		(id: string, newName: string, newPrice: number) => {
